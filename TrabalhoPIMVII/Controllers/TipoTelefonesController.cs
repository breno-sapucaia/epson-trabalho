...
namespace TrabalhoPIMVII.Controllers
{
    public class TipoTelefonesController : Controller
    {
        ...
        public TipoTelefonesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TipoTelefoneId,Tipo")] TipoTelefone tipoTelefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoTelefoneId,Tipo")] TipoTelefone tipoTelefone)
        {
